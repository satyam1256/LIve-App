...
class Database(object):
    def __init__(self):
        self.client = MongoClient("mongodb+srv://Satyam:DtgwbcblfuekTDQ6@cluster0.engobf0.mongodb.net/newOverlay")  # configure db url
        self.db = self.client['newOverlay']  # configure db name
